...
#	def cds_exonno(self):
	...
	def position_info(self, cds_pos, ref_fasta_dict):
		...
		return pos_info
	def introns(self, which_exons='exon'):
		...
		Note exons include 5'UTR 3'UTR so using only CDS may miss introns
		which_exons allows you to infer introns between other feature types, namely CDS - but be cautious
		"""
		sorted_exons = self.sorted_feats(which_exons)
		self.feats['intron'] = {}
